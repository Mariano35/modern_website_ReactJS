    ...
    <nav className='w-full flex py-6 justify-between items-center navbar'>
      ...
      <ul className="list-none sm:flex hidden justify-end items-center flex-1">
        {navLinks.map((nav, index) => (
          <li
            key={nav.id}
            //El elemento ${index ===} lo que quiere decir ese código es que si es el último link de la navegación, por eso el navLinks.length -1, aplicale un mr de 0 sino aplicale un mr de 10 
      ...
      {/* //Div para dispositivos más pequeños     */}
